...
def generate_launch_description():
    ...
    ld.add_action(
        DeclareLaunchArgument(
            name="urdf_package",
            default_value="igris_c_description",
    ...
    ld.add_action(
        DeclareLaunchArgument(
            name="urdf_path",
            default_value="urdf/igris_c_v2.urdf.xacro",
            description="Path to URDF or xacro file inside the package",
        )
    )
    ...
    ld.add_action(
        DeclareLaunchArgument(
            name="hand_type",
            default_value="dummy",
            description="End effector type for xacro models",
        )
    )
